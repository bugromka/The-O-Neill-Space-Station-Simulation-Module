...
T(ox, oy-ORB-100,
  'на светило круглый год — и у Солнца, и у другой звезды.', size=8.4,
...
for i,(k,v) in enumerate([
    ...
    ('нос (к Солнцу)','стыковка · радиаторы · крылья батарей'),
    ('корма (к Земле)','антенны · радиаторы · крылья батарей'),
